...
import {
  ...
  ImagePlus, X, ArrowLeft, ArrowRight, AlertCircle, Images,
} from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg card-shadow p-4 space-y-3">
        <h3 className="font-heading font-semibold text-sm">Create a post</h3>
      ...
      <div>
        <h3 className="font-heading font-semibold text-sm mb-3">My posts</h3>
